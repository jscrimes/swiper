...
import { h } from '../jc-swiper.core.js';
/**
 * SSR Window 1.0.1
...
var Virtual = {
    update: function (force) {
        ...
        prependIndexes.sort(function (a, b) { return a < b; }).forEach(function (index$$1) {
...
var JcSwiper = /** @class */ (function () {
    function JcSwiper() {
    }
    JcSwiper.prototype.componentDidLoad = function () {
        this.options = {
    ...
    JcSwiper.prototype.initSwiper = function () {
    ...
    JcSwiper.prototype.update = function () {
        this.swiper.update();
    };
    JcSwiper.prototype.render = function () {
        var _this = this;
        return (h("div", { class: "swiper-container", ref: function (el) { return _this.container = el; } }, h("div", { class: "swiper-wrapper", ref: function (el) { return _this.wrapper = el; } }, h("slot", null))));
    };
    Object.defineProperty(JcSwiper, "is", {
        get: function () { return "jc-swiper"; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(JcSwiper, "properties", {
        get: function () {
            return {
                "loop": {
                    "type": Boolean,
